...
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL || 'https://ehvrcyllauhuqbldbdsm.supabase.co';
const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY || 'sb_publishable_LmHyqojttKmlLekNvlKn4Q_2KdtNh4Z';

if (!import.meta.env.VITE_SUPABASE_URL || !import.meta.env.VITE_SUPABASE_ANON_KEY) {
    console.warn('Supabase environment variables missing. Using fallback/hardcoded credentials.');
}
