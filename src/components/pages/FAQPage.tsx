  ...
  const faqs = [
    {
      ...
      answer:
        'You can book a test by calling us at +91 7875426669, messaging us on WhatsApp, or visiting our lab directly. For home sample collection, simply share your address and preferred time slot via WhatsApp, and we\'ll arrange a convenient pickup.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'You can reach our customer support team via phone at +91 7875426669, WhatsApp at the same number, or email us at info@firstcarelab.in. Our support is available Monday to Saturday from 7 AM to 9 PM and Sunday from 8 AM to 6 PM.',
    },
    {
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a
              href="mailto:info@firstcarelab.in"
